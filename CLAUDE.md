...
| Status        | Thema                                                                                                                                                                                                  |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **erledigt**  | Partnerships-Refactor: Alle 11 Phasen abgeschlossen 2026-05-03. iOS-Stack komplett auf Partnerships umgebaut (Phasen 5–7): Models/Services/ViewModels/Views; PartnersView mit Section-List, AddPartnerSheet, PartnerFiltersView, Overflow-Views. Deep Links + Push-Routing (Phase 8). Apple Sign-In (Phase 9) + Google Sign-In (Phase 10) aktiv. Docs (Phase 11) fertig. |
| **erledigt**  | GoogleSignIn SPM-Package (`https://github.com/google/GoogleSignIn-iOS`) in Xcode hinzugefügt; reversed Client-ID URL Scheme `com.googleusercontent.apps.600845465744-4cjhu5pv0fnslqfbmtjf8r4tcm54buki` eingetragen. Google Sign-In auf echtem Gerät getestet (2026-05-03). |
